// Named functions
export declare function AddDoorToSystemNew(doorHash: string | number, p1: boolean, p2: boolean, p3: boolean, threadId: number, p5: number, p6: boolean): void;
...
export declare function BreakAllObjectFragmentBones(object: Record<string, any>): void;
export declare function BreakObjectFragmentChild(p0: Record<string, any>, p1: any, p2: boolean): void;
...
export declare function CreateObject(modelHash: string | number, x: number, y: number, z: number, isNetwork: boolean, bScriptHostObj: boolean, dynamic: boolean, p7: boolean, p8: boolean): Record<string, any>;
export declare function CreateObjectNoOffset(modelHash: string | number, x: number, y: number, z: number, isNetwork: boolean, bScriptHostObj: boolean, dynamic: boolean, p7: boolean): Record<string, any>;
export declare function CreateObjectSkeleton(object: Record<string, any>): boolean;
...
export declare function DoorSystemSetAutomaticDistance(doorHash: string | number, distance: number): void;
export declare function DoorSystemSetAutomaticRate(doorHash: string | number, rate: number): void;
export declare function DoorSystemSetDoorState(doorHash: string | number, state: number): void;
export declare function DoorSystemSetOpenRatio(doorHash: string | number, ajar: number, forceUpdate: boolean): void;
...
export declare function IsDoorRegisteredWithNetwork(doorHash: string | number): boolean;
export declare function IsDoorRegisteredWithSystem(doorHash: string | number): boolean;
export declare function IsObjectAPickup(object: Record<string, any>): boolean;
export declare function IsObjectVisible(object: Record<string, any>): boolean;
export declare function IsPickupTypeValid(pickupHash: string | number): boolean;
...
export declare function PreventCollectionOfPortablePickup(object: Record<string, any>, p1: boolean, p2: boolean): void;
...
export declare function SetCustomTexturesOnObject(object: Record<string, any>, txdHash: string | number, p2: any, p3: any): void;
...
export declare function SetMaxNumPortablePickupsCarriedByPlayer(modelHash: string | number, p1: number): void;
export declare function SetObjectAllowLowLodBuoyancy(object: Record<string, any>, toggle: boolean): void;
export declare function SetObjectBurnIntensity(object: Record<string, any>, intensity: number): void;
export declare function SetObjectBurnLevel(object: Record<string, any>, burnLevel: number, affectAsh: boolean): void;
export declare function SetObjectBurnOpacity(object: Record<string, any>, opacity: number): void;
export declare function SetObjectBurnSpeed(object: Record<string, any>, speed: number, p2: number): void;
...
export declare function SetObjectTargettable2(object: Record<string, any>, targettable: boolean): void;
export declare function SetObjectTextureVariation(object: Record<string, any>, textureVariation: number): void;
export declare function SetPickupDoNotAutoPlaceOnGround(pickupObject: Record<string, any>): void;
