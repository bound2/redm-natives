...
export declare function ClearLaunchParam(): const char;
...
export declare function GetLaunchParamExists(): [boolean, const char];
export declare function GetLaunchParamString(): const char;
export declare function GetLaunchParamValue(): [const char, const char];
...
export declare function MugshotTextureDownloadRequest(p1: number, p3: boolean): [number, any, const char];
...
export declare function NetworkAddFriend(): [boolean, any, const char];
...
export declare function NetworkGetGamertagFromFriend(): [const char, any];
export declare function NetworkGetGamertagFromHandle(): [const char, any];
...
export declare function NetworkGetRosTitleName(): const char;
...
export declare function NetworkIsScriptActive(p1: number, p2: boolean, p3: number): [boolean, const char];
...
export declare function ReportPlayer(player: number, reportType: number): [const char, const char];
...
export declare function SetLaunchParamString(): const char;
export declare function SetLaunchParamValue(): [const char, const char];
...
export declare function TextureDownloadGetName(p0: number): const char;
export declare function TextureDownloadRelease(p0: number): void;
export declare function TextureDownloadRequest(p3: boolean): [number, number, const char, const char];
export declare function UgcClearQueryResults(p0: any): void;
export declare function UgcDidRequestSucceed(p0: any): boolean;
export declare function UgcGetCachedDescription(p0: number, length: number): const char;
...
export declare function UgcQueryByContentId(latestVersion: boolean): [boolean, const char, const char];
...
export declare function UgcRequestContentDataFromParams(fileId: number, fileVersion: number, languageId: number): [number, const char, const char];
...
export declare function N_0x2c4e98dda475364f(): const char;
