// Named functions
export declare function AddEntityToAudioMixGroup(entity: number, p2: number): string;
export declare function AddPedToConversation(ped: number): [string, string];
export declare function AudioIsScriptedMusicPlaying(): boolean;
export declare function CancelMusicEvent(): [boolean, string];
export declare function CanPedSpeak(ped: number, unk: boolean): [boolean, string];
export declare function ClearAmbientZoneListState(p1: boolean): any;
export declare function ClearAmbientZoneState(p1: boolean): string;
...
export declare function ForceVehicleEngineAudio(vehicle: number): string;
...
export declare function PauseScriptedConversation(p1: boolean, p2: boolean, p3: boolean, p4: boolean): string;
export declare function PlayAmbientSpeechFromPositionNative(x: number, y: number, z: number): [boolean, any];
export declare function PlayAnimalVocalization(pedHandle: number, p2: boolean): string;
...
export declare function PlaySound(p2: boolean, p3: any, p4: boolean, p5: any): [string, string];
export declare function PlaySoundFromEntity(entity: number, isNetwork: boolean, p4: any, p5: any): [string, string];
export declare function PlaySoundFromPosition(x: number, y: number, z: number, isNetwork: boolean, p6: any, p7: boolean, p8: any): [string, string];
export declare function PlaySoundFrontend(p2: boolean, p3: any): [string, string];
...
export declare function PreloadScriptConversation(p1: boolean, p2: boolean, p3: boolean): string;
...
export declare function PrepareSoundset(p1: boolean): [boolean, string];
export declare function PrepareSoundWithEntity(entity: number, soundId: number): [boolean, string, string];
...
export declare function SetAmbientVoiceName(ped: number): string;
export declare function SetAmbientZoneListState(p1: boolean, p2: boolean): any;
export declare function SetAmbientZoneListStatePersistent(p1: boolean, p2: boolean): string;
export declare function SetAmbientZoneState(p1: boolean, p2: boolean): string;
export declare function SetAmbientZoneStatePersistent(p1: boolean, p2: boolean): string;
...
export declare function SetAudioOnlineTransitionStage(): string;
...
export declare function StartScriptConversation(p1: boolean, p2: boolean, p3: boolean): string;
...
export declare function StopScriptedConversation(p1: boolean, p2: boolean): [number, string];
