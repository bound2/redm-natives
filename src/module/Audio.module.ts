...
export declare function IsScriptedConversationPlaying(p0: string): boolean;
...
export declare function PrepareSoundset(soundsetName: string, p1: boolean): boolean;
export declare function PrepareSoundWithEntity(soundName: string, entity: number, soundsetName: string, soundId: number): boolean;
...
export declare function SetAudioOnlineTransitionStage(p0: string): void;
