...
export declare function AreStringsEqual(): [boolean, const char, const char];
...
export declare function CompareStrings(matchCase: boolean, maxLength: number): [number, const char, const char];
export declare function CopyMemory(size: number): [any, any];
export declare function CreateColorString(rgb: number): const char;
...
export declare function DisplayOnscreenKeyboard(p0: number, maxInputLength: number): [const char, const char, const char, const char, const char, const char];
...
export declare function DoesStringExistInString(): [boolean, const char, const char];
...
export declare function GetHashKey(): [string | number, const char];
...
export declare function GetLootingEventHasFired(ped: number): [boolean, const char];
...
export declare function GetOnscreenKeyboardResult(): const char;
...
export declare function GetStringFromBool(value: boolean): const char;
export declare function GetStringFromFloat(value: number, digits: number): const char;
export declare function GetStringFromVector(x: number, y: number, z: number): const char;
...
export declare function IntToString(value: number, buffer: string): const char;
...
export declare function IsStringNull(): [boolean, const char];
export declare function IsStringNullOrEmpty(): [boolean, const char];
export declare function IsStringNullOrEmptyOrSpaces(): [boolean, const char];
...
export declare function RegisterInteractionLockonPrompt(entity: number, p2: number, p3: number, p4: number, p5: number, p6: number, prompt: Prompt, p8: boolean, p9: number): [boolean, const char];
...
export declare function ResetWeatherVariation(p1: boolean): const char;
...
export declare function SetWeatherVariation(): [const char, const char];
...
export declare function StringToInt(): [boolean, const char, number];
...
export declare function VarString(flags: number, ...: ): const char;
...
export declare function N_0x1694a053dfb61a34(): const char;
...
export declare function N_0x708df841b8f27aa2(): const char;
...
export declare function N_0x91d657230bc208d2(): [const char, const char];
...
export declare function N_0x9935f76407c32539(): const char;
...
export declare function N_0xcc7fc854b956a128(): [const char, const char];
