...
export declare function GetLootingEventHasFired(ped: number, eventName: string): boolean;
...
export declare function RegisterInteractionLockonPrompt(entity: number, p1: string, p2: number, p3: number, p4: number, p5: number, p6: number, prompt: number, p8: boolean, p9: number): boolean;
...
export declare function ResetWeatherVariation(weatherType: string, p1: boolean): void;
