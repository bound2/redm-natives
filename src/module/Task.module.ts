...
export declare function GetScenarioPointEntity(scenarioPoint: number): [number, string];
...
export declare function GetTaskMoveNetworkEvent(ped: number): [boolean, string];
...
export declare function GetWaypointDistanceAlongRoute(p1: number): [number, string];
...
export declare function PlayAnimOnRunningScenario(ped: number): [string, string];
...
export declare function RequestTaskMoveNetworkStateTransition(ped: number): string;
...
export declare function SetEnhancedBreakFree(ped: number, p1: boolean): [boolean, string];
...
export declare function SetTaskMoveNetworkSignalBool(ped: number, value: boolean): string;
export declare function SetTaskMoveNetworkSignalFloat(ped: number, value: number): string;
export declare function SetTaskMoveNetworkSignalVector(ped: number, x: number, y: number, z: number): string;
...
export declare function StopAnimTask(ped: number, p3: number): [string, string];
...
export declare function TaskCower(ped: number, duration: number, ped2: number): string;
...
export declare function TaskMoveNetworkByName(ped: number, multiplier: number, p3: boolean, flags: number): [string, string];
export declare function TaskMoveNetworkByNameWithInitParams(ped: number, p3: number, p4: boolean, flags: number): [string, any, string];
export declare function TaskPatrol(ped: number, p2: any, p3: boolean, p4: boolean): string;
...
export declare function TaskPlayAnim(ped: number, speed: number, speedMultiplier: number, duration: number, flags: number, playbackRate: number, p8: boolean, p9: any, p10: boolean, p12: boolean): [string, string, string];
export declare function TaskPlayAnimAdvanced(ped: number, posX: number, posY: number, posZ: number, rotX: number, rotY: number, rotZ: number, speed: number, speedMultiplier: number, duration: number, flags: number, p13: number, p14: number, p15: number, p16: number): [string, string];
...
export declare function TaskPlayUpperAnimFacingEntity(ped: number, entity: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: boolean, p10: boolean, p11: number, p13: number, p14: number): [string, string, string];
...
export declare function TaskStandGuard(ped: number, x: number, y: number, z: number, heading: number): string;
export declare function TaskStandStill(ped: number, time: number): void;
export declare function TaskStartScenarioAtPosition(ped: number, scenarioHash: string | number, x: number, y: number, z: number, heading: number, duration: number, sittingScenario: boolean, teleport: boolean, p10: number, p11: boolean): string;
export declare function TaskStartScenarioInPlace2(ped: number, p1: any, p3: number, p4: boolean, p5: number, p6: boolean): string;
...
export declare function TaskUseScenarioPoint(ped: number, p1: any, p3: number, p4: boolean, p5: boolean, p6: string | number, p7: boolean, p8: number, p9: boolean): string;
export declare function TaskUseScenarioPoint2(ped: number, ped2: number, p2: any, p4: number, p5: string | number, p6: number, p7: boolean): string;
...
export declare function WaypointRecordingGetClosestWaypoint(x: number, y: number, z: number): [boolean, string, number];
export declare function WaypointRecordingGetCoord(point: number): [boolean, string, [number, number, number]];
