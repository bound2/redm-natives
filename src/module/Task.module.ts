...
export declare function GetScenarioPointCloseToCoords(posX: number, posY: number, posZ: number, radius: number, size: number): [number, any];
export declare function GetScenarioPointCoords(scenario: number, p1: boolean): [number, number, number];
export declare function GetScenarioPointEntity(scenarioPoint: number, name: string): number;
...
export declare function SetTaskMoveNetworkSignalVector(ped: number, signalName: string, x: number, y: number, z: number): void;
...
export declare function TaskCombatAnimalCharge(ped: number, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any): void;
...
export declare function TaskEmote(ped: number, category: number, p2: number, emoteType: string | number, p4: boolean, p5: boolean, p6: boolean, p7: boolean, p8: boolean): void;
export declare function TaskEmote2(ped: number, category: number, p2: number, emoteType: string | number, p4: boolean, p5: boolean, p6: boolean, p7: boolean, p8: boolean): void;
...
export declare function TaskFollowToOffsetOfEntity(ped: number, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any, p7: any, p8: any, p9: any, p10: any, p11: any, p12: any): void;
...
export declare function TaskMoveInTraffic2(ped: number, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any, p7: any): void;
export declare function TaskMoveInTraffic3(ped: number, p1: any, p2: any, p3: any, p4: any): void;
...
export declare function TaskMoveNetworkByNameWithInitParams(ped: number, p1: string, p3: number, p4: boolean, animDict: string, flags: number): any;
...
export declare function TaskStartScenarioAtPosition(ped: number, scenarioHash: string | number, x: number, y: number, z: number, heading: number, duration: number, sittingScenario: boolean, teleport: boolean, p9: string, p10: number, p11: boolean): void;
...
export declare function N_0xcf9b71c0af824036(p0: any, p1: any): any;
