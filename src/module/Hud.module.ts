...
export declare function BusyspinnerSetText(): string;
export declare function ClearAllHelpMessages(): void;
export declare function CreateFakeMpGamerTag(ped: number, pointedClanTag: boolean, isRockstarClan: boolean, p5: any): [number, string, string];
export declare function CreateMpGamerTag(player: number, pointedClanTag: boolean, isRockstarClan: boolean, p5: any): [number, string, string];
export declare function CreateMpGamerTagOnEntity(entity: number): [number, string];
...
export declare function DisplayText(xPos: number, yPos: number): string;
...
export declare function GetLabelText(): [string, string];
export declare function GetLabelText2(): [string, string];
...
export declare function RegisterNamedRendertarget(p1: boolean): [boolean, string];
...
export declare function SetMissionName(p0: boolean): string;
export declare function SetMissionName2(p0: boolean): string;
...
export declare function SetMpGamerTagNamePosse(gamerTagId: number): string;
...
export declare function TextBlockDelete(): string;
export declare function TextBlockIsLoaded(): [boolean, string];
export declare function TextBlockRequest(): string;
...
export declare function UipromptCreate(inputHash: string | number, p2: any, p3: any, p4: any, p5: number): [Prompt, string];
...
export declare function UipromptSetText(prompt: Prompt): string;
