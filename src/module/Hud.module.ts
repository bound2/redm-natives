...
export declare function UipromptCreate(inputHash: string | number, p2: any, p3: any, p4: any, p5: number): [number, string];
...
export declare function UipromptSetText(prompt: number): string;
