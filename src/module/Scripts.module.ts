...
export declare function BailWithPassThroughParams(p0: string): void;
...
export declare function DisplayLoadingScreens(p0: string | number, p1: string | number, p2: string | number, gamemodeName: string, title: string, subtitle: string): void;
