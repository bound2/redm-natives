// Named functions
export declare function BailToLandingPage(p0: number): void;
export declare function BailWithPassThroughParams(): const char;
export declare function BgEndContext(): const char;
...
export declare function BgStartContext(): const char;
...
export declare function DisplayLoadingScreens(p0: string | number, p1: string | number, p2: string | number): [const char, const char, const char];
export declare function DoesCompressedGlobalBlockBufferExist(index: number): boolean;
export declare function DoesScriptExist(): [boolean, const char];
...
export declare function HasScriptLoaded(): [boolean, const char];
...
export declare function NetRpcGuidToString(): [const char, any];
export declare function RequestScript(): const char;
...
export declare function SetScriptAsNoLongerNeeded(): const char;
...
export declare function StartNewScript(stackSize: number): [number, const char];
export declare function StartNewScriptWithArgs(argCount: number, stackSize: number): [number, const char, any];
...
export declare function StopDisplayingMpTransitionLoadingScreens(p0: any): void;
...
export declare function N_0x4ae1dff337a86fde(scriptIndex: number): [boolean, const char];
export declare function N_0x50b72a754ee64a71(p0: any): void;
export declare function N_0x54ae4fdeefeab77e(): any;
export declare function N_0x55c40b7592bad213(scriptIndex: number): [number, const char];
