...
export declare function BailWithPassThroughParams(): string;
...
export declare function DisplayLoadingScreens(p0: string | number, p1: string | number, p2: string | number): [string, string, string];
...
export declare function N_0x4ae1dff337a86fde(scriptIndex: number): [boolean, string];
export declare function N_0x50b72a754ee64a71(p0: any): void;
export declare function N_0x54ae4fdeefeab77e(): any;
export declare function N_0x55c40b7592bad213(scriptIndex: number): [number, string];
