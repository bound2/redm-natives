...
export declare function GetEntityAnimCurrentTime(entity: number): [number, string, string];
export declare function GetEntityAttachedTo(entity: number): number;
export declare function GetEntityBoneIndexByName(entity: number): [number, string];
...
export declare function HasEntityAnimFinished(entity: number, p3: number): [boolean, string, string];
...
export declare function IsEntityPlayingAnim(entity: number, taskFlag: number): [boolean, string, string];
...
export declare function PlayEntityAnim(entity: number, p3: number, loop: boolean, stayInAnim: boolean, p6: boolean, delta: number, bitset: any): [boolean, string, string];
...
export declare function SetEntityAnimCurrentTime(entity: number, time: number): [string, string];
export declare function SetEntityAnimSpeed(entity: number, speedMultiplier: number): [string, string];
...
export declare function StopEntityAnim(entity: number, p3: number): [any, string, string];
