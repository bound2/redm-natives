...
export declare function CashinventoryTransactionAddItem(id: number, p2: number): [boolean, any];
export declare function CashinventoryTransactionAddItemWithIngredients(id: number, p2: number, p4: number): [boolean, any, any];
...
export declare function N_0x52bde32f21ba3b6d(p0: any, p1: any, p2: any, p3: any): any;
