...
export declare function IsPopzoneValid(popZone: number): boolean;
export declare function SetPopzonePopulationSet(popZone: number, populationSetHash: string | number): void;
export declare function SetSpawnerInfoPriority(p0: string | number, p1: string | number, priority: number): void;
// Hash functions
export declare function N_0x08892122769770d5(popZone: number, p1: boolean): void;
export declare function N_0x0f1861101c9a9944(popZone: number, p1: boolean): void;
...
export declare function N_0x7e6bc0b94f5928f0(popZone: number, p1: number, p2: number): void;
