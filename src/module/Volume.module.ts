// Named functions
export declare function AddBoxVolumeToVolumeAggregate(aggregate: Volume, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number): void;
export declare function AddCylinderVolumeToVolumeAggregate(aggregate: Volume, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number): void;
export declare function AddSphereVolumeToVolumeAggregate(aggregate: Volume, p1: number, p2: number, p3: number, p4: number, p5: number, p6: number, p7: number, p8: number, p9: number): void;
...
export declare function CreateVolumeSphereWithCustomName(p0: any, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any, p7: any, p8: any, p9: any): Volume;
export declare function CreateWalkAndTalkVolume(p0: any, p1: any, p2: any, p3: any, p4: any, p5: any, p6: any, p7: any, p8: any, p9: any, p10: any, p11: any, p12: any): Volume;
export declare function DeleteVolume(volume: Volume): void;
...
export declare function DoesVolumeExist(volume: Volume): boolean;
export declare function GetVolumeBounds(volume: Volume): [[number, number, number], [number, number, number]];
export declare function GetVolumeCoords(volume: Volume): [number, number, number];
export declare function GetVolumeLockRequestStatus(volLockRequestId: number): number;
export declare function GetVolumeRotation(volume: Volume): [number, number, number];
export declare function GetVolumeScale(volume: Volume): [number, number, number];
export declare function IsPointInVolume(volume: Volume, x: number, y: number, z: number): boolean;
...
export declare function SetVolumeCoords(volume: Volume, posX: number, posY: number, posZ: number): boolean;
export declare function SetVolumeOwnerPersistentCharacter(volume: Volume, persChar: PersChar, p2: boolean): void;
export declare function SetVolumeRotation(volume: Volume, rotX: number, rotY: number, rotZ: number): boolean;
export declare function SetVolumeScale(volume: Volume, scaleX: number, scaleY: number, scaleZ: number): boolean;
// Hash functions
